...
export default function setCreditFooter(data) {
    ...
    setLabelAndFaIcon(a, { prefix: 'brands', icon: 'github' }, `${data.name} `, false);
    ...
    const fonts = {};
    fonts['Montserrat'] = `https://fonts.gstatic.com/s/montserrat/v26/JTUHjIg1_i6t8kCHKm4532VJOt5-QNFgpCtr6Hw5aXo.woff2`;
    fonts['Bad Script'] = 'https://fonts.gstatic.com/s/badscript/v16/6NUT8F6PJgbFWQn47_x7pOskzA.woff2';
